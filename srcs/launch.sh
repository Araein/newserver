...
openssl req -newkey rsa:4096 -x509 -sha256 -days 365 -nodes -out /etc/nginx/ssl/localhost-key.key -keyout /etc/nginx/ssl/localhost.pem -subj "/C=FR/ST=Paris/L=Paris/O=42 School/OU=wpuser/CN=localhost"
